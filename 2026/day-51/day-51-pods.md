...
# I entered the Nginx container:

```bash
kubectl exec -it nginx-pod -- /bin/bash

# Then I tested the Nginx web server:
```bash
curl localhost:80
...
This confirmed that Nginx was successfully installed and running inside the Kubernetes Pod.

![Nginx curl test](images/01-nginx-curl.png)
...
**Verify:** Can you see "Hello from BusyBox" in the logs?
   ...
   ![BusyBox logs](images/03-busybox-logs.png)
...
![Pod labels](images/04-pod-labels.png)
...
![Pods running](images/02-pods-running.png) 

![Final Pods](images/06-pods-running-final.png)
